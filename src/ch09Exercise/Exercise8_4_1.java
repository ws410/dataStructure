...
public class Exercise8_4_1 {
    ...
    public static void createSearchList() throws Exception {
        ...
        for (int i = 1; i < curlen; i++) {  //输入关键字序列
            k[i] = new KeyType(d[i-1]);
            System.out.print(d[i-1]+" ");
        }
        System.out.println("");
        ST.insert(0, new RecordNode(0));    //在0号单元插入一个元素0
        for (int i = 1; i < curlen; i++) {  //记录顺序表
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("seqSearchWithGuard(" + key1.key + ")=" + ST.seqSearchWithGuard(key1));
        System.out.println("seqSearchWithGuard(" + key2.key + ")=" + ST.seqSearchWithGuard(key2));
    }
}
...
请输入2个待查找的关键字:
83 36
seqSearchWithGuard(83)=7
seqSearchWithGuard(36)=-1
 */