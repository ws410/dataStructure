...
public class Exercise8_3_2 extends SeqList {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("");
        System.out.println("binarySearchRecursively(" + key1.key + ")=" + ST.binarySearchRecursively(0, ST.length() - 1, key1));
        System.out.println("binarySearchRecursively(" + key2.key + ")=" + ST.binarySearchRecursively(0, ST.length() - 1, key2));
